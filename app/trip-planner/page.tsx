            ...
            {[
              {
                ...
                text: "Get a practical day-by-day travel plan based on your selected destination and trip duration.",
              },
              {
                icon: Wallet,
                title: "Budget-aware planning",
                text: "Plan smarter with your own budget so the itinerary feels realistic for Indian travelers.",
              },
              {
                icon: Clock,
                title: "Fast AI planning",
                text: "Generate a useful trip outline in seconds and refine your plan before booking anything.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <section className="mx-auto max-w-4xl px-6 py-16">
          <div className="rounded-[2rem] border border-zinc-200 bg-zinc-50 p-8 text-center">
            ...
            <p className="mt-3 text-zinc-600">
              Your destination, days, budget, and travel style are being used to
