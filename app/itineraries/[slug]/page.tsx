...
export default async function ItineraryDetailPage({ params }: PageProps) {
  ...
  const itineraryDestinationMap: Record<string, string> = {
    ...
    "3-days-in-varanasi": "varanasi",
    "3-days-in-agra": "agra",
    "5-days-in-leh-ladakh": "leh",
    "4-days-in-coorg": "coorg",
    "4-days-in-ooty": "ooty",
    "5-days-in-spiti-valley": "spiti-valley",
    "3-days-in-kasol": "kasol",
    "3-days-in-dwarka": "dwarka",
    "2-days-in-somnath": "somnath",
    "3-days-in-gir-national-park": "gir-national-park",
    "3-days-in-mahabaleshwar": "mahabaleshwar",
    "3-days-in-diu": "diu",
  };
  ...
  const itineraryBlogMap: Record<string, string> = {
    ...
    "3-days-in-varanasi": "complete-varanasi-travel-guide",
    "3-days-in-agra": "complete-agra-travel-guide",
    "5-days-in-leh-ladakh": "complete-leh-ladakh-travel-guide",
    "4-days-in-coorg": "best-time-to-visit-coorg",
    "4-days-in-ooty": "best-time-to-visit-ooty",
    "5-days-in-spiti-valley": "complete-spiti-valley-travel-guide",
    "3-days-in-kasol": "complete-kasol-travel-guide",
    "3-days-in-dwarka": "best-time-to-visit-dwarka",
    "2-days-in-somnath": "best-time-to-visit-somnath",
    "3-days-in-gir-national-park": "complete-gir-national-park-travel-guide",
    "3-days-in-mahabaleshwar": "best-time-to-visit-mahabaleshwar",
    "3-days-in-diu": "best-time-to-visit-diu",
  };
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:py-20">
        ...
        <section className="mt-10">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-2xl leading-7 text-zinc-600">
              Follow this practical route with morning, afternoon, evening,
              travel time, estimated cost, and food recommendations.
            </p>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-6 grid gap-4">
                      <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-5">
                        <div className="mb-3 flex items-center gap-2">
                          ...
                          <h4 className="font-black text-zinc-950">Morning</h4>
                        </div>
                      ...
                      <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-5">
                        <div className="mb-3 flex items-center gap-2">
                          ...
                          <h4 className="font-black text-zinc-950">Evening</h4>
                        </div>
                        <p className="leading-7 text-zinc-700">
                          {day.evening}
                        </p>
                    ...
                    <div className="mt-5 grid gap-4 md:grid-cols-3">
                      <div className="rounded-3xl border border-orange-100 bg-orange-50 p-5">
                        <Clock size={20} className="mb-2 text-orange-500" />
                        <h4 className="font-black text-zinc-950">
                          Travel Time
                        </h4>
                      ...
                      <div className="rounded-3xl border border-orange-100 bg-orange-50 p-5">
                        <Wallet size={20} className="mb-2 text-orange-500" />
                        <h4 className="font-black text-zinc-950">
                          Approx. Cost
                        </h4>
                        <p className="mt-2 leading-7 text-zinc-700">
                      ...
                      <div className="rounded-3xl border border-orange-100 bg-orange-50 p-5">
                        <Utensils size={20} className="mb-2 text-orange-500" />
                        <h4 className="font-black text-zinc-950">
                          Food Recommendation
                        </h4>
                        <p className="mt-2 leading-7 text-zinc-700">
        ...
        <section className="mt-16 grid gap-6 lg:grid-cols-2">
          <div className="rounded-[2rem] border border-zinc-200 bg-zinc-50 p-6 shadow-sm">
            ...
            <p className="mt-3 leading-7 text-zinc-600">
              Estimated total trip budget for this itinerary:
            </p>
          ...
          <div className="rounded-[2rem] border border-orange-100 bg-orange-50 p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                "Start sightseeing early to avoid crowds.",
                "Keep local transport options ready.",
                "Carry some cash for local markets and small attractions.",
              ].map((tip) => (
                <div key={tip} className="flex gap-3 rounded-2xl bg-white p-4">
                  <CheckCircle2
                    size={18}
        ...
        <section className="mt-16">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 leading-7 text-zinc-600">
                Yes. You can add or remove attractions based on your interests,
                budget, season, and available time.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-zinc-950 p-8 text-white shadow-2xl md:p-12">
            ...
            <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
              <div>
                ...
                <p className="mt-4 max-w-2xl leading-7 text-zinc-300">
                  Explore destinations, itineraries, and practical travel
                  inspiration for your next India trip.
                </p>
              </div>
