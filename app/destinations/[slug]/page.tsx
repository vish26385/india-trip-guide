...
//           <div className="mt-6 space-y-3">
//             <Link
//               //href={`/trip-planner?destination=${encodeURIComponent(destination.name)}`}
//               //href={`/trip-planner?destination=${encodeURIComponent(destination.name)}&days=${destination.duration}`}
//               href={`/trip-planner?destination=${encodeURIComponent(destination.name)}&days=${parseInt(destination.duration)}`}
//               className="block rounded-full bg-orange-500 px-5 py-3 text-center text-sm font-black text-white transition hover:bg-orange-600"
//             >
//               Plan Trip
//             </Link>
